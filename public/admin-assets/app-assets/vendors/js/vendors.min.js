...
function(e, t) {
  ...
  class Vt extends H {
      ...
      _setListeners() {
        if (!this._element) {
            return; // Exit early if _element is undefined
        }
        ...
        // Check if this._element.closest is defined before using it
        if (this._element.closest) {
            const modal = this._element.closest(".modal");
            if (modal) {
                D.on(modal, "hide.bs.modal", this._hideModalHandler);
            }
        }
...
function(e, t) {
  ...
  function l(e, t, n, i, o) {
    ...
    try {
        ...
        // Check if i is not null before sending
        if (i !== null) {
            r.send(i);
        } else {
            // Handle the case when i is null
            console && console.log("Parameter 'i' is null");
        }
    } catch (e) {
