          ...
          value: function() {
              ...
              return new Promise((resolve, reject) => {
                if (null !== t.el) {
                    ...
                    var beforeMountEvent = t.w.config.chart.events.beforeMount;
                    if (typeof beforeMountEvent === 'function') {
                        beforeMountEvent(t, t.w);
                    }
                    ...
                    var series = t.create(t.w.config.series, {});
                    if (!series) {
                        resolve(t);
                    }
                    t.mount(series).then(() => {
                        if (typeof t.w.config.chart.events.mounted === 'function') {
