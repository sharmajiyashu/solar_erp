                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @if (!empty($agent->id))
                                        <form class="form" action="{{ route('admin.agents.update', $agent->id) }}"
                                            method="POST" enctype="multipart/form-data" id="submitFrom">
                                            @method('put')
                                        @else
                                            <form class="form" action="{{ route('admin.agents.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="first-name-column">Profile <span
                                                        class="error"></span></label>
                                                @if (!empty($agent->profile))
                                                    <div>
                                                        <img src="{{ url('public/storage/' . $agent->profile) }}"
                                                            alt="" width="200" height="200">
                                                    </div>
                                                @endif
                                                <input type="file" id="first-name-column" name="profile"
                                                    class="form-control" value="" accept="image/*" />
                                                <span class="text-danger validation-class"
                                                    id="profile-submit_errors"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="name" name="name" class="form-control"
                                                    placeholder="Full Name" value="{{ $agent->name ?? '' }}" />
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="mobile" name="mobile" class="form-control"
                                                    placeholder="Mobile Number" value="{{ $agent->mobile ?? '' }}" />
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="email" id="email" name="email" class="form-control"
                                                    placeholder="Email Address" value="{{ $agent->email ?? '' }}" />
