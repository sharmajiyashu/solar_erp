                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @if (!empty($user->id))
                                        <form class="form" action="{{ route('admin.admin_users.update', $user->id) }}"
                                            method="POST" enctype="multipart/form-data" id="submitFrom">
                                            @method('put')
                                        @else
                                            <form class="form" action="{{ route('admin.admin_users.store') }}" method="POST"
                                    ...
                                    {{ csrf_field() }}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="name-column">Name <span class="error"></span></label>
                                                    <input type="text" id="name-column" name="name" class="form-control" placeholder="Name"  value="{{ $user->name ?? '' }}" />
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <select name="role_id" id="" class="form-select select2">
                                                        <option value="">Select Role</option>
                                                        @foreach ($roles as $item)
                                                            <option value="{{ $item->id }}" 
                                                                {{ (isset($user->role_id) && $user->role_id == $item->id) ? 'selected' : '' }}
                                                                >{{ $item->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <span class="text-danger validation-class" id="role_id-submit_errors"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="first-name-column" name="password" class="form-control" placeholder="Enter Password"  value="{{ $user->password_2 ?? '' }}" />
