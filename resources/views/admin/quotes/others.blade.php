                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form" action="{{ route('admin.quotes.others.store') }}" method="POST"
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="title" name="title" class="form-control"
                                                        placeholder="Title" value="{{ $other->title ?? '' }}" />
                                                    <span class="text-danger validation-class"
                                                        id="title-submit_errors"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="notes">Notes <span
                                                            class="error"></span></label>
                                                    <textarea id="notes" name="notes" class="form-control" rows="3" placeholder="Notes">{{ $other->notes ?? '' }}</textarea>
                                                    <span class="text-danger validation-class"
